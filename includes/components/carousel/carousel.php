        ...
        <div class="app-carousel-wrap" page="0" total="<?php echo count($carousel_data['items'])?>">
            <div class="app-carousel-wrapper">
                <?php for($i = 0;$i<count($carousel_data['items']);$i++){ ?>
                    <a class="app-carousel-row" href="<?php echo $carousel_data['link'].$carousel_data['items'][$i]['id']?>" target="_blank" style="width: calc(100% / <?php echo count($carousel_data['items'])?>);">
